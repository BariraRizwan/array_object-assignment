...
let addArrays = people.friends = [friend1,friend2,friend3];
...
for(let r = 0 ; r<=4 ; r++){
  if(students[r].senior===true){
    console.log(`${students[r].name} have completed her all assignments`);
  }
  else{
    console.log(`${students[r].name} have not completed her all assignments`);
  }
}
